            ...
            <div className="about">
                ...
                <div className='instruction'>
                    ...
                    <ol>
                        ...
                        <img src={new_node} alt="node created" />
                        <li>
                            ...
                            <img src={add_definition} alt="add definition" />
                        </li>
                        <li>
                            ...
                            <img src={toggle_definition} alt="definition added" />
                        </li>
                        <li>
                            ...
                            <img src={add_nexus} alt="add nexus" />
                        </li>
                        <li>
                            ...
                            <img src={nexus_added} alt="nexus added" />
                        </li>
                        <li>
                            ...
                            <img src={edit_mode} alt="edit mode" />
                        </li>
